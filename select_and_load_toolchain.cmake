...
if(CMAKE_GENERATOR STREQUAL "Ninja" AND NOT DEFINED ${TOOLCHAIN_VAR})
    ...
    elseif(UNIX AND NOT (CYGWIN OR APPLE) AND 
          ( (CMAKE_C_COMPILER_ID STREQUAL "Clang" OR CMAKE_C_COMPILER MATCHES "clang${CMAKE_EXECUTABLE_SUFFIX}") 
    ...
    elseif(UNIX AND NOT (CYGWIN OR APPLE) AND 
          ...
          OR (CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER MATCHES "gcc") ) )
