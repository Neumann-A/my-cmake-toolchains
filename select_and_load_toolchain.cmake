...
cmake_print_variables(CMAKE_SYSTEM_NAME CMAKE_C_COMPILER_ID CMAKE_GENERATOR CMAKE_GENERATOR_TOOLSET)
...
if(CMAKE_GENERATOR STREQUAL "Ninja" AND NOT DEFINED VCPKG_CHAINLOAD_TOOLCHAIN_FILE)
    ...
    elseif(UNIX AND NOT (CYGWIN OR APPLE) AND CMAKE_C_COMPILER_ID STREQUAL "Clang")
    ...
    elseif(UNIX AND NOT (CYGWIN OR APPLE) AND CMAKE_C_COMPILER_ID STREQUAL "GNU")
